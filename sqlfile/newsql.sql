...
CREATE TABLE `tenent` (
  ...
  `Role` enum('tenant') NOT NULL DEFAULT 'tenant',
...
INSERT INTO `tenent` (`id`, `UserName`, `Email`, `Password`, `Role`, `CreatedAt`) VALUES
(0, 'tenent', 'tenent@vrs.com', '81dc9bdb52d04dc20036dbd8313ed055', 'tenant', '2025-04-02 13:46:55');
